...
Singleton {
    ...
    Connections {
        ...
        function onMatugenFailed() {
            ...
            root.lastError = "No se pudo generar la paleta automatica.";
        ...
        function onBackendError(area, message) {
            root.lastError = message;
            OsdService.showMessage("󰅚", message);
        }
    ...
    function runMatugen(wallpaperPath, announce) {
        announce = announce === undefined ? true : announce;
