...
Singleton {
    ...
    function rebuildAppCaches() {
        const apps = DesktopEntries.applications.values.slice().sort((a, b) => {
    ...
    Component.onCompleted: rebuildAppCaches()
