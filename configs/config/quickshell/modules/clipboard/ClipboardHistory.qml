...
PanelWindow {
    ...
    Loader {
        ...
        sourceComponent: Rectangle {
            ...
            height: Math.max(fixedHeight, fixedHeight + listHeight)
            ...
            ColumnLayout {
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        property bool isPinned: ClipboardService.pinnedItems.includes(delegateItem.modelData?.text ?? "")
                        ...
                        RowLayout {
                            ...
                            // Length hint for long entries
                            Text {
                                visible: (delegateItem.modelData?.text?.length ?? 0) > 80
                                text: "(" + (delegateItem.modelData?.text?.length ?? 0) + " chars)"
                                color: Config.mutedColor
                                font.family: Config.font
                                font.pixelSize: Config.fontSizeSmall
                            ...
                            // Pin button
                            Rectangle {
                                visible: delegateItem.isPinned || delegateItem.isHovered || delegateItem.isSelected
                                Layout.preferredWidth: 24
                                Layout.preferredHeight: 24
                                radius: height / 2
                                color: pinMouse.containsMouse ? Config.surface2Color : "transparent"
                                ...
                                Text {
                                    ...
                                    font.family: Config.font
                                    font.pixelSize: 14
                                    color: delegateItem.isPinned ? Config.accentColor : (pinMouse.containsMouse ? Config.textColor : Config.mutedColor)
                                }
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: ClipboardService.togglePin(delegateItem.modelData?.text ?? "")
                                }
                            }
