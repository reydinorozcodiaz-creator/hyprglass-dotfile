...
Rectangle {
    ...
    // Cache hover state to avoid re-evaluating color on every mouse move
    readonly property bool isHovered: mainMouse.containsMouse || (detailsMouse.containsMouse && hasDetails)
