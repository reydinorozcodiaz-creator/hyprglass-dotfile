...
Item {
    ...
    // Night light color palette (warm amber tones, intentionally not theme-dependent)
    readonly property color colorCandle:  "#ff6b00"
    readonly property color colorWarm:   "#ff9500"
    readonly property color colorNeutral: "#ffcc00"
    readonly property color colorCool:   "#fff5e6"
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        gradient: Gradient {
                            ...
                            GradientStop {
                                position: 0.0
                                color: root.colorWarm
                            }
                            GradientStop {
                                position: 0.5
                                color: root.colorNeutral
                            }
                            GradientStop {
                                position: 1.0
                                color: "#ffffff"
