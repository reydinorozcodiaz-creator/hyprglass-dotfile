...
Item {
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                Layout.leftMargin: 10
                Layout.rightMargin: 10
                text: "Changes apply to GTK and Qt apps simultaneously"
                font.family: Config.font
                font.pixelSize: Config.fontSizeSmall
                color: Config.subtextColor
            }
            ...
            SystemThemeSection {
                icon: "󰔎"
                title: "GTK Theme"
                currentValue: ThemeService.systemGtkTheme
                model: ThemeService.availableGtkThemes
                onItemSelected: name => ThemeService.setSystemGtkTheme(name)
            }
            ...
            SystemThemeSection {
                icon: "󰀻"
                title: "Icon Theme"
                currentValue: ThemeService.systemIconTheme
                model: ThemeService.availableIconThemes
                onItemSelected: name => ThemeService.setSystemIconTheme(name)
            }
            ...
            SystemThemeSection {
                icon: "󰇀"
                title: "Cursor Theme"
                currentValue: ThemeService.systemCursorTheme
                model: ThemeService.availableCursorThemes
                onItemSelected: name => ThemeService.setSystemCursorTheme(name)
            }
    ...
    // ====================================================================
    // REUSABLE: Collapsible theme section
    // ====================================================================

    component SystemThemeSection: ColumnLayout {
        id: section
        ...
        Rectangle {
            ...
            radius: Config.radius
            color: sectionHeaderMouse.containsMouse ? Config.surface1Color : Config.surface0Color
            border.width: 1
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: section.currentValue || "Not set"
                        font.family: Config.font
                        font.pixelSize: Config.fontSizeSmall
                        color: Config.subtextColor
                        elide: Text.ElideRight
        ...
        ColumnLayout {
            ...
            Repeater {
                model: section.expanded ? section.model : []
                ...
                delegate: Rectangle {
                    ...
                    readonly property bool isCurrent: modelData === section.currentValue

                    Layout.fillWidth: true
                    Layout.preferredHeight: 36
                    radius: Config.radiusSmall
                    color: {
                        if (isCurrent) return Qt.alpha(Config.accentColor, 0.15);
                        if (optionMouse.containsMouse) return Config.surface1Color;
                        return "transparent";
                    }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.family: Config.font
                            font.pixelSize: Config.fontSizeSmall
                            font.bold: optionItem.isCurrent
                            color: optionItem.isCurrent ? Config.accentColor : Config.textColor
                            elide: Text.ElideRight
                            Layout.fillWidth: true
                        }
                    }
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            if (!optionItem.isCurrent)
                                section.itemSelected(optionItem.modelData);
                        }
                    }
                }
            }
