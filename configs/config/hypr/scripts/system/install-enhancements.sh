...
windowrulev2 = workspace 1, class:^(kitty|Alacritty)$
windowrulev2 = workspace 2, class:^(code|VSCodium|jetbrains-idea-ce)$
windowrulev2 = workspace 3, class:^(firefox|brave-browser)$
...
windowrulev2 = workspace 7, class:^(Steam|lutris|heroic)$
